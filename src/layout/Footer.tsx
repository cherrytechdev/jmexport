  ...
  return (
    <section>
      <Container className="pb-10">
        <img
          src="/images/vanilla_logo.png"
          alt="Vanilla logo"
          className="w-[255px] md:w-[355px]"
        />
        <div className="flex flex-col-reverse gap-8 md:grid grid-cols-3">
          <div>
            <p className="text-[#121213]">Plus d&apos;information</p>
            <span className="text-[#898686] text-sm">
              © 2025JMExport. All rights reserved.
            </span>
          </div>
